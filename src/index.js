  ...
  render(){
    ...
    return (
      ...
      <HashRouter>
        ...
        <Route path="/" render = {()=><EventList web3 ={this.state.superWeb3} account={this.state.superAccount} contract = {this.state.superContract} setSuperWeb3 = {this.callbackFunction} setSuperContract={this.setSuperContract}/>}/>
        ...
        <Route path="/check-in" render = {()=><CheckIn web3 ={this.state.superWeb3} account={this.state.superAccount} contract = {this.state.superContract} setSuperWeb3 = {this.callbackFunction} setSuperContract={this.setSuperContract}/>}/>
      </HashRouter>
